...
syscall(void)
{
  ...
  num = p->trapframe->a7;  //Original Line
// Introducing  a bug to our code to cause a crash

  //num = * (int *) 0; // Bugged line
//This line is trying to read an integer from memory address 0(Invalid Address) 
